...
function closeBuyerFollowUp(){document.querySelectorAll('.buyer-followup-overlay').forEach(node=>node.remove());document.body.classList.remove('buyer-followup-open')}
