const CACHE='agnt-beta-v1.36.11-buyers-followup';
const ASSETS=['./','./index.html','./styles.css?v=1.36.11-beta-buyers-followup','./app.js?v=1.36.11-beta-buyers-followup','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
