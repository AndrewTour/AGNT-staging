const CACHE='agnt-beta-v1.36.12-buyers-context-contrast';
const ASSETS=['./','./index.html','./styles.css?v=1.36.12-beta-buyers-context-contrast','./app.js?v=1.36.12-beta-buyers-context-contrast','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
