const CACHE='agnt-staging-teams-v2-1.33.2-team-workflow';
const ASSETS=['./','./index.html','./styles.css?v=1.33.2-staging-team-workflow','./app.js?v=1.33.2-staging-team-workflow','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
