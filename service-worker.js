const CACHE='agnt-staging-teams-v2-1.32.1';
const ASSETS=['./','./index.html','./styles.css?v=1.32.1-staging','./app.js?v=1.32.1-staging','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
