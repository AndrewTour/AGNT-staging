const CACHE='agnt-staging-v1.36.22-free-prospector-map-1';
const ASSETS=['./','./index.html','./styles.css?v=1.36.22-free-map-1','./app.js?v=1.36.22-free-map-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
