const CACHE='agnt-beta-v1.36.13-buyer-followup-modal';
const ASSETS=['./','./index.html','./styles.css?v=1.36.13-beta-buyer-followup-modal','./app.js?v=1.36.13-beta-buyer-followup-modal','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
