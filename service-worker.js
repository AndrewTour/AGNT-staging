const CACHE='agnt-staging-v1.34.8-consumer-login';
const ASSETS=['./','./index.html','./styles.css?v=1.34.8-consumer-login','./app.js?v=1.34.8-consumer-login','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
