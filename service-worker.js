const CACHE='agnt-beta-v1.36.8-buyers-ui';
const ASSETS=['./','./index.html','./styles.css?v=1.36.8-beta-buyers-ui','./app.js?v=1.36.8-beta-buyers-ui','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
