const CACHE='agnt-beta-v1.36.14-buyer-followup-controls';
const ASSETS=['./','./index.html','./styles.css?v=1.36.14-beta-buyer-followup-controls','./app.js?v=1.36.14-beta-buyer-followup-controls','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
