const CACHE='agnt-staging-v1.36.20-prospector-map-1';
const ASSETS=['./','./index.html','./styles.css?v=1.36.20-map-staging-1','./app.js?v=1.36.20-map-staging-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
