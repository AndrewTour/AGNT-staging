const CACHE='agnt-staging-v1.34.1-ui-polish';
const ASSETS=['./','./index.html','./styles.css?v=1.34.1-staging-ui-polish','./app.js?v=1.34.1-staging-ui-polish','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
