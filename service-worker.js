const CACHE='agnt-beta-v1.36.0-team-appointments';
const ASSETS=['./','./index.html','./styles.css?v=1.36.0-team-appointments','./app.js?v=1.36.0-team-appointments','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
