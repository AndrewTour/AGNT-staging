const CACHE='agnt-staging-teams-v2-1.32.7-team-sync';
const ASSETS=['./','./index.html','./styles.css?v=1.32.7-staging-team-sync','./app.js?v=1.32.7-staging-team-sync','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
