const CACHE='agnt-staging-teams-v2-1.32.6-passkey-poc';
const ASSETS=['./','./index.html','./styles.css?v=1.32.6-staging-passkey','./app.js?v=1.32.6-staging-passkey','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
