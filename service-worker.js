const CACHE='agnt-beta-v1.36.21-daily-run-sheet';
const ASSETS=['./','./index.html','./styles.css?v=1.36.21-beta-daily-run-sheet','./app.js?v=1.36.21-beta-daily-run-sheet','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
